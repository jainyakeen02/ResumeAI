    ...
    >
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <button
          ...
          className="lg:hidden p-2 rounded-xl text-slate-600 hover:bg-sky-50 hover:text-sky-700 transition-colors shrink-0"
        ...
        {/* Search */}
        <div
          className="flex-1 flex items-center max-w-sm gap-2 px-3 sm:px-4 py-2 rounded-xl text-sm"
      ...
      <div className="flex items-center gap-2 sm:gap-3 ml-2 sm:ml-4 shrink-0">
        ...
        <button className="relative p-2 rounded-lg text-slate-500 hover:text-sky-700 hover:bg-sky-50 transition-all">
          <Bell size={18} />
          <span
            className="absolute top-1.5 right-1.5 w-1.5 h-1.5 bg-sky-400 rounded-full"
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-2 px-2.5 sm:px-3 py-1.5 rounded-xl transition-all"
            style={{
