    ...
    >
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 text-sm">Sign in to your ResumeAI account</p>
        </div>
        ...
        >
          ...
          <p className="text-center text-slate-500 mt-7 text-sm">
            ...
            <Link to="/register" className="text-sky-600 font-medium hover:text-sky-700 transition-colors">
              Create one
            </Link>
          </p>
        </div>
